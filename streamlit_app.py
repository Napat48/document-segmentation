...
Original file is located at
    https://colab.research.google.com/drive/1T6lvXZTLWlkUCqvsY41Gl3w1oSiCNiea
"""
...
st.title("📄 Multiple Document Scanner (YOLOv11)")
st.write("อัปโหลดรูปภาพที่มีเอกสารหลายใบ → ระบบจะตัด/ปรับมุม/ลบเงา → รวมเป็น PDF")
